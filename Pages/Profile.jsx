    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }} className="flex-1">
        ...
        >
          ...
          <Text className="mt-4 text-2xl font-bold text-slate-900">Mani</Text>
          <Text className="mt-1 text-base font-medium text-slate-500">+91 98765433</Text>
        </Animated.View>

        {/* Score Card - Fades in Down with delay */}
        <Animated.View 
          entering={FadeInDown.delay(200).duration(600).springify()}
          className="w-1/2 mx-auto mb-10 items-center rounded-3xl border border-orange-100/50 bg-orange-50 py-2"
        >
        ...
        >
          <TouchableOpacity className="flex-row items-center justify-center rounded-2xl border border-red-400 py-4 active:bg-red-100" onPress={() => {navigation.navigate('Login')}}>
